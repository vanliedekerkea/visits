...
public class JdbcPetRepositoryImpl implements PetRepository {
    ...
    @Autowired
    public JdbcPetRepositoryImpl(DataSource dataSource, CustomerRepository customerRepository, VisitRepository visitRepository) {
    ...
    public Pet findById(int id) throws DataAccessException {
        ...
        try {
            ...
            pet = this.namedParameterJdbcTemplate.queryForObject(
                    "SELECT id, name, birth_date, type_id, customer_id FROM pets WHERE id=:id",
                    params,
                    new JdbcPetRowMapper());
        } catch (EmptyResultDataAccessException ex) {
            throw new ObjectRetrievalFailureException(Pet.class, new Integer(id));
        }
        Customer customer = this.customerRepository.findById(pet.getCustomerId());
        customer.addPet(pet);
    ...
    private MapSqlParameterSource createPetParameterSource(Pet pet) {
        return new MapSqlParameterSource()
                ...
                .addValue("customer_id", pet.getCustomer().getId());
    }
