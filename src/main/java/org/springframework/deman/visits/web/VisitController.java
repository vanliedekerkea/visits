...
public class VisitController {
    ...
    @RequestMapping(value = "/customers/*/pets/{petId}/visits/new", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/customers/{customerId}/pets/{petId}/visits/new", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/customers/*/pets/{petId}/visits", method = RequestMethod.GET)
